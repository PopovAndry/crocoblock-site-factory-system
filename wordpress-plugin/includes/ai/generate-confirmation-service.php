...
function factory_ai_generate_confirmation_runtime_diff_evidence(
	...
	return [
		...
		'hero_variant'                               => sanitize_key( (string) ( $dry_run_preview['hero_variant'] ?? 'image_left_scrim' ) ),
		'hero_variant_proof'                         => is_array( $dry_run_preview['hero_variant_proof'] ?? null ) ? $dry_run_preview['hero_variant_proof'] : [],
		'design_profile'                             => is_array( $dry_run_preview['design_profile'] ?? null ) ? $dry_run_preview['design_profile'] : [],
		'style_context'                              => is_array( $dry_run_preview['style_context'] ?? null ) ? $dry_run_preview['style_context'] : [],
		'style_tokens'                               => is_array( $dry_run_preview['style_tokens'] ?? null ) ? $dry_run_preview['style_tokens'] : [],
		'image_context'                              => is_array( $dry_run_preview['image_context'] ?? null ) ? $dry_run_preview['image_context'] : [],
		'current_counts'                             => [
...
function factory_ai_generate_confirmation_normalize_runtime_diff_evidence( $evidence ): array {
	...
	return [
		...
		'hero_variant'                               => sanitize_key( (string) ( $evidence['hero_variant'] ?? 'image_left_scrim' ) ),
		'hero_variant_proof'                         => is_array( $evidence['hero_variant_proof'] ?? null ) ? $evidence['hero_variant_proof'] : [],
		'design_profile'                             => is_array( $evidence['design_profile'] ?? null ) ? $evidence['design_profile'] : [],
		'style_context'                              => is_array( $evidence['style_context'] ?? null ) ? $evidence['style_context'] : [],
		'style_tokens'                               => is_array( $evidence['style_tokens'] ?? null ) ? $evidence['style_tokens'] : [],
		'image_context'                              => is_array( $evidence['image_context'] ?? null ) ? $evidence['image_context'] : [],
