...
class Factory_AI_Blueprint_Generator {
	...
	private string $cache_dir = '/var/www/blueprints/cache';
	private bool $last_from_cache = false;

	public function __construct(
		string $source_path = '/var/www/blueprints/examples/real-estate.generated.json',
		string $target_path = '/var/www/blueprints/generated/real-estate-ai.json'
	) {
...
public function generate_from_prompt( string $user_prompt ): array {
	...
	file_put_contents(
		'/var/www/blueprints/last-ai-response.txt',
		$content
	);
...
Supported structure:
{
  ...
  "theme": {
    "slug": "kava",
    "path": "/var/www/themes/kava.zip"
  },
  "plugins": [
    {
      "slug": "jet-engine",
      "path": "/var/www/plugins/jet-engine.zip",
      "activate": true
    }
  ],
  "taxonomies": [
