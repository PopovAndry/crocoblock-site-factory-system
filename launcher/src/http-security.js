...
const ROUTE_INVENTORY = Object.freeze([
  ...
  { id: "ui_create_website", method: "GET", group: "health_static_ui", mutation: false, signature: "/assets/create-website-ui.js", match: { type: "exact", value: "/assets/create-website-ui.js" } },
  ...
  { id: "create_website_start", method: "POST", group: "mutation", mutation: true, sourceSignature: 'requestUrl.pathname === "/api/create-websites"', signature: "/api/create-websites", match: { type: "exact", value: "/api/create-websites" } },
  { id: "create_website_status", method: "GET", group: "read_only", mutation: false, sourceSignature: '/^\\/api\\/create-websites\\/[^/]+$/', signature: "/api/create-websites/:slug", match: { type: "regex", value: /^\/api\/create-websites\/[^/]+$/ } },
  ...
  { id: "viewing_date_preview", method: "POST", group: "planning_preview", mutation: false, sourceSignature: '/^\\/api\\/projects\\/[^/]+\\/viewing-date\\/preview$/', signature: "/api/projects/:slug/viewing-date/preview", match: { type: "regex", value: /^\/api\/projects\/[^/]+\/viewing-date\/preview$/ } },
  { id: "viewing_date_recovery_prepare", method: "POST", group: "mutation", mutation: true, sourceSignature: '/^\\/api\\/projects\\/[^/]+\\/viewing-date\\/recovery-point$/', signature: "/api/projects/:slug/viewing-date/recovery-point", match: { type: "regex", value: /^\/api\/projects\/[^/]+\/viewing-date\/recovery-point$/ } },
  { id: "viewing_date_apply", method: "POST", group: "mutation", mutation: true, sourceSignature: '/^\\/api\\/projects\\/[^/]+\\/viewing-date\\/apply$/', signature: "/api/projects/:slug/viewing-date/apply", match: { type: "regex", value: /^\/api\/projects\/[^/]+\/viewing-date\/apply$/ } },
  { id: "viewing_date_restore", method: "POST", group: "mutation", mutation: true, sourceSignature: '/^\\/api\\/projects\\/[^/]+\\/viewing-date\\/restore$/', signature: "/api/projects/:slug/viewing-date/restore", match: { type: "regex", value: /^\/api\/projects\/[^/]+\/viewing-date\/restore$/ } },
